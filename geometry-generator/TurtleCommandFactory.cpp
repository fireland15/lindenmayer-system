...
namespace fli {
	namespace geometry_generator {
		TurtleCommandFactory::TurtleCommandFactory(std::unique_ptr<ITurtleCommandSet> commandSet)
			: m_commandSet(std::move(commandSet)) { }

		TurtleCommand TurtleCommandFactory::BuildCommand(LindenmayerSymbol symbol) {
